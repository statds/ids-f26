...
\usepackage{enumitem}
\setlist{parsep=0pt, leftmargin=4mm, topsep=0pt, itemsep=6pt}
...
\item[Course Description:]
  ...
  analyzing, and making inferences from data. Topics include project
  management, data preparation, data visualization, statistical models,
  machine learning, distributed computing, and ethics.

\item[Course Materials:]
  Lecture notes, assignments, sample code, datasets, and other private course
  material will be posted on HuskyCT at \url{https://lms.uconn.edu/}.
...
\item[Computing:]
  ...
  GitHub Classroom will be used for homework submission and grading. Practice
...
\item[Course Notes:]
  The instructor-authored
  \href{https://statds.github.io/ids-book/}{Introduction to Data Science book}
  contains the permanent course notes. The Fall 2026
  \href{https://statds.github.io/ids-f26/}{collaborative notes site}
  organizes student-created RevealJS presentations. Its source is publicly
  available in the
  \href{https://github.com/statds/ids-f26}{Fall 2026 GitHub repository}.

  Earlier collaborative notes include
  \href{https://statds.github.io/ids-s26}{Spring 2026},
  \href{https://statds.github.io/ids-f25}{Fall 2025},
  \href{https://statds.github.io/ids-s25}{Spring 2025}, and
  \href{https://statds.github.io/ids-f24}{Fall 2024}.

\item[Fall 2026 Calendar:]
  The semester begins Monday, August 31. Labor Day, Monday, September 7, has
  no classes. Thanksgiving recess runs Sunday, November 22, through Sunday,
  November 29. The final two instructional weeks, Monday, November 30,
...
\item Submitted work that duplicates or copies another solution receives no
  credit.
\end{itemize}

\item[Topic Presentations: 20 points]
  Students select topics from the public task board, obtain approval, prepare
  a RevealJS slide deck, and present it to the class. The presentation must be
  submitted for preview at least one week before the scheduled presentation;
  approval and timely preview account for 4 points. The oral presentation
  accounts for 10 points. Successful completion of a pull request containing
...
\item[Generative Artificial Intelligence:]
  ...
  ideas. Homework, topic presentations, the midterm project, and final projects
  must be completed through the student's own work. Any AI use related to
  submitted work must be disclosed. Students remain responsible for verifying
